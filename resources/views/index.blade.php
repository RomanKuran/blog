...
<body>
    ...
    <div class="table_container">
        ...
        <div class='ok'>Message changed</div>
        <div class='no'>Something is wrong</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h5>Name message:</h5>
                    <input type="text" name="name_message" id="name_message" class="name_message">
                    <h5>Message:</h5>
                    <textarea rows="4" cols="50" name="message" id="message" class="message"></textarea>
                    <br>
                    <button class="btn" id="btn_edit">OK</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <textarea rows="4" cols="50" name="message" id="message" class="message"></textarea>
                    <br>
                    <button class="btn" id="btn_insert">OK</button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                </div>
